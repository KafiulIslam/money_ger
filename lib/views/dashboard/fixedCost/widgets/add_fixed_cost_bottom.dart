      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Consumer<FixedCostProvider>(
                builder: (_, fixedCostState, child) {
                  return Column(
                      ...
                      PrimaryButton(
                        onTap: () {
                          if (_expenseAmount.text.isNotEmpty) {
                            fixedCostState.addFixedCost(
                                AppConstant.currentMonthId, _description.text,
                                _selectedExpenseType.text,
                                int.parse(_expenseAmount.text), false, context);
                          }
                        },
                        buttonTitle: 'Save',
                        isLoading: fixedCostState.isFixedCostAdding,
                      ),
